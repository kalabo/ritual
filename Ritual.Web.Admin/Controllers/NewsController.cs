...
namespace Ritual.Web.Admin.Controllers
{
    public class NewsController : Controller
    {
        ...
        public ActionResult Index(string sortOrder, string searchString, string currentFilter, int? page)
        {
            ...
            var news = db.News.Include(n => n.AspNetUserModifiedBy).Include(n => n.AspNetUserCreatedBy).Include(n => n.Location).Include(n => n.NewsCategory);
            
            switch (sortOrder)
            {
                case "modified_asc":
                    news = news.OrderBy(s => s.ModifiedDate);
                    break;
                default:
                    news = news.OrderByDescending(s => s.ModifiedDate);
                    break;
            } 
