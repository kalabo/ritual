...
namespace Ritual.Web.Admin.Controllers
{
    public class MembershipsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            var members =
              db.Members
                ...
                {
                    MemberId = s.Id,
                    Description = string.Format("{0} {1}", s.AspNetUser.FirstName, s.AspNetUser.LastName)
                });

            ViewBag.MemberId = new SelectList(members, "MemberId", "Description");
        ...
        public ActionResult Create([Bind(Include = "Id,MemberId,PackageId,StartDate,EndDate,Trial,MembershipStateId,CancellationDate,Paid,InitialPaymentDate,InitialPayment,MonthlyPrice,TotalPrice,DiscountPercentage,DiscountPrice,DiscountReason")] Membership membership)
        {
            ...
            ViewBag.MemberId = new SelectList(db.Members, "Id", "AspNetUserId", membership.MemberId);
