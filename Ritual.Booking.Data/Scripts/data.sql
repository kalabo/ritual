...
GO
INSERT [dbo].[SessionBooking] ([Id], [MemberId], [LocationId], [Date], [BookingStateId], [RPEFeeling], [RPEPush], [TrainerNotes], [TrainerId], [TimeSlotId]) VALUES (1, 1, 2, CAST(N'2015-01-30' AS Date), 1, 7, 8, NULL, 1, 44)
GO
INSERT [dbo].[SessionBooking] ([Id], [MemberId], [LocationId], [Date], [BookingStateId], [RPEFeeling], [RPEPush], [TrainerNotes], [TrainerId], [TimeSlotId]) VALUES (2, 2, 2, CAST(N'2015-01-30' AS Date), 1, 8, 10, NULL, 1, 44)
GO
INSERT [dbo].[SessionBooking] ([Id], [MemberId], [LocationId], [Date], [BookingStateId], [RPEFeeling], [RPEPush], [TrainerNotes], [TrainerId], [TimeSlotId]) VALUES (3, 1, 2, CAST(N'2015-01-10' AS Date), 3, 8, 8, NULL, 1, 20)
GO
INSERT [dbo].[SessionBooking] ([Id], [MemberId], [LocationId], [Date], [BookingStateId], [RPEFeeling], [RPEPush], [TrainerNotes], [TrainerId], [TimeSlotId]) VALUES (4, 1, 2, CAST(N'2015-01-10' AS Date), 2, 0, 0, NULL, 1, 21)
GO
INSERT [dbo].[SessionBooking] ([Id], [MemberId], [LocationId], [Date], [BookingStateId], [RPEFeeling], [RPEPush], [TrainerNotes], [TrainerId], [TimeSlotId]) VALUES (6, 1, 2, CAST(N'2015-01-31' AS Date), 1, 0, 0, NULL, 1, 29)
GO
INSERT [dbo].[SessionBooking] ([Id], [MemberId], [LocationId], [Date], [BookingStateId], [RPEFeeling], [RPEPush], [TrainerNotes], [TrainerId], [TimeSlotId]) VALUES (7, 1, 2, CAST(N'2015-02-02' AS Date), 1, 0, 0, NULL, 1, 17)
GO
INSERT [dbo].[SessionBooking] ([Id], [MemberId], [LocationId], [Date], [BookingStateId], [RPEFeeling], [RPEPush], [TrainerNotes], [TrainerId], [TimeSlotId]) VALUES (8, 1, 2, CAST(N'2015-02-02' AS Date), 1, 0, 0, NULL, 1, 37)
GO
